function MenuState(name) {
	...
	btns.push(new MenuButton("Acerca de ", 20, _yPos+140, function() {
		state.change("about", true);
	}));
	btns.push(new MenuButton("Mi Github", 20, _yPos+210, function() {
		window.open("https://github.com/Arturo09ruiz");
	}));
...
function AboutState(name) {
	...
	var text = "Hola esto suena raro pero visita MI GITHUB HAZLO ¡";
	var hastick = false;
